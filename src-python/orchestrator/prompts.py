"""Prompts for the orchestrator routing logic."""

ROUTING_SYSTEM_PROMPT = """You are a routing assistant that determines which specialist tool should handle a user query about financial products.
...
ROUTING_USER_PROMPT = """Analyze this user query and determine the routing:
